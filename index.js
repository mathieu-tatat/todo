...
function addTodo() {
  ...
  if (taskText !== '') {
    ...
    let share = document.querySelector('.share-button'+i);
      share.addEventListener('click', e => {
        const taskShare = share.previousElementSibling.textContent;
        const newTaskShare = prompt('Partager la tâche :', taskShare);
        if (newTaskShare !== null && newTaskShare !== '') {
          share.previousElementSibling.textContent = newTaskShare;
        }
      })
      i++;
      console.log(share);
